...
public class CustomResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public final ResponseEntity<Object> handleJourneyIdException(JourneyIdException ex, WebRequest request){
        JourneyIdExceptionResponse exceptionResponse = new JourneyIdExceptionResponse(ex.getMessage());
        return new ResponseEntity(exceptionResponse, HttpStatus.BAD_REQUEST);
    }
